...
本项目基于[awesome-cybersecurity-blueteam](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,566 | 🐛 80 | 📅 2024-07-15，经过蹩脚的翻译和一些补充，**旨在帮助以中文为母语的安全研究者更好地了解蓝队工作，以及便利地找寻蓝队工具**。
...
* [python-stix2](https://github.com/oasis-open/cti-python-stix2) ⭐ 438 | 🐛 67 | 🌐 Python | 📅 2026-02-12 - 用于序列化和反序列化STIX（JSON形式）的Python API，以及一些用于常见任务的高级API
  * 补充：STIX是用来交换威胁情报的一种语言和序列化格式，由MITRE联合DHS（美国国土安全部）发布
* [libcrafter](https://github.com/pellegre/libcrafter) ⭐ 312 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - 一个c++的高级库，用于创建和解码网络数据包
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,278 | 🐛 891 | 🌐 Go | 📅 2026-09-12 - 用Go编写的应用程序内核，它实现Linux系统表面的很大一部分，用以在应用程序和主机内核之间提供隔离边界
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,800 | 🐛 368 | 🌐 Python | 📅 2026-09-11 - 基于AWS-CLI命令的工具，用于Amazon Web Services帐户安全性评估和增强
...
* [Clair](https://github.com/coreos/clair) ⭐ 11,059 | 🐛 52 | 🌐 Go | 📅 2026-09-09 - 静态分析工具，用于探测应用容器镜像（e.g. Docker）中的漏洞
...
另请参阅：[awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,553 | 🐛 25 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,160 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - 可以自承载的Honey Token生成器及报告模版，演示版本可查看：[CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,554 | 🐛 49 | 🌐 C | 📅 2024-06-03 - 一种SSH tarpit，可以缓慢地发送无休止的SSH banner
...
另请参阅：[awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,378 | 🐛 81 | 📅 2026-07-15.
...
* [King Phisher](https://github.com/securestate/king-phisher) ⭐ 2,587 | 🐛 2 | 🌐 Python | 📅 2026-08-04 - 通过模拟真实的网络钓鱼攻击来测试和提高用户意识的工具
...
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,769 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - 可以使系统看起来像APT攻击受害者的工具集
...
* [Wazuh](https://wazuh.com/) - 开源的、基于多平台代理的安全监视平台。基于[OSSEC HIDS](https://github.com/ossec/ossec-hids) ⭐ 5,057 | 🐛 124 | 🌐 C | 📅 2026-08-26分支开发
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,600 | 🐛 35 | 🌐 Python | 📅 2026-09-10 - 一个恶意网络流量检测系统
* [Moloch](https://github.com/aol/moloch) ⭐ 7,463 | 🐛 37 | 🌐 C | 📅 2026-09-11 - 可扩展当前的安全基础架构，以标准的PCAP格式存储和索引网络流量，从而实现快速的索引访问
* [Stenographer](https://github.com/google/stenographer) ⚠️ Archived - 可进行全包捕获的实用程序，用于将数据包缓冲到磁盘以进行入侵检测和事件响应
* [VAST](https://github.com/tenzir/vast) ⭐ 758 | 🐛 0 | 🌐 C++ | 📅 2026-09-11 - 一个用于数据驱动的安全调查的免费开源网络遥测引擎
...
另请参阅：[awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,119 | 🐛 0 | 📅 2026-09-02.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,562 | 🐛 654 | 🌐 C++ | 📅 2026-09-09 - 一个适用于macOS、Windows和Linux的操作系统插装框架，其将操作系统公开为高性能关系数据库，可以使用类似sql的语法进行查询
...
另请参阅：[awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,722 | 🐛 56 | 📅 2026-01-05.
