# Awesome Cybersecurity Blue Team - CN with stars

> 攻防对抗 · 蓝队清单，中文版

本项目基于[awesome-cybersecurity-blueteam](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,554 | 🐛 77 | 📅 2024-07-15，经过蹩脚的翻译和一些补充，**旨在帮助以中文为母语的安全研究者更好地了解蓝队工作，以及便利地找寻蓝队工具**。
...
>
> 关于攻防对抗的TTPs（战术、技术和过程），请查看这个项目：[awesome-pentest](https://github.com/fabacab/awesome-pentest) ⭐ 281 | 🐛 0 | 📅 2023-10-23.
>
...
* [DShell](https://github.com/USArmyResearchLab/Dshell) ⭐ 5,494 | 🐛 4 | 🌐 Python | 📅 2024-05-07 - 用Python编写网络取证分析框架，支持扩展，可快速开发插件来分析捕获的网络数据包
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,249 | 🐛 159 | 🌐 Shell | 📅 2026-07-25 - 对于自动解密的可插入式工具，经常被用做[Tang](https://github.com/latchset/tang) ⭐ 726 | 🐛 41 | 🌐 C | 📅 2025-03-06客户端
...
* [MultiScanner](https://github.com/mitre/multiscanner) ⭐ 621 | 🐛 39 | 🌐 Python | 📅 2019-10-08 - 使用Python编写的文件分析框架，支持自动运行相关的工具，汇总输出帮助评估一组带分析的文件
* [censys-python](https://github.com/censys/censys-python) ⭐ 469 | 🐛 1 | 🌐 Python | 📅 2026-08-28 - 对Censys REST API的Python轻量级封装
* [python-stix2](https://github.com/oasis-open/cti-python-stix2) ⭐ 435 | 🐛 67 | 🌐 Python | 📅 2026-02-12 - 用于序列化和反序列化STIX（JSON形式）的Python API，以及一些用于常见任务的高级API
  * 补充：STIX是用来交换威胁情报的一种语言和序列化格式，由MITRE联合DHS（美国国土安全部）发布
* [libcrafter](https://github.com/pellegre/libcrafter) ⭐ 311 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 - 一个c++的高级库，用于创建和解码网络数据包
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,216 | 🐛 861 | 🌐 Go | 📅 2026-09-02 - 用Go编写的应用程序内核，它实现Linux系统表面的很大一部分，用以在应用程序和主机内核之间提供隔离边界
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,736 | 🐛 356 | 🌐 Python | 📅 2026-09-01 - 基于AWS-CLI命令的工具，用于Amazon Web Services帐户安全性评估和增强
* [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,809 | 🐛 296 | 🌐 Python | 📅 2025-09-23 - 开源的多云安全审核工具，可用于评估云环境的安全状态
...
* [GPG Sync](https://github.com/firstlookmedia/gpgsync) ⚠️ Archived - 用于在组织和团队中进行自动化OpenPGP公钥集成和分发。

## DevSecOps

另请参阅：[awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,462 | 🐛 85 | 📅 2024-05-11

补充：DevOps旨在加强开发人员，IT运营和安全性之间的关系。

* [Git Secrets](https://github.com/awslabs/git-secrets) ⭐ 13,388 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - 用于防止用户提交密码或其他的敏感信息到Git仓库
* [Clair](https://github.com/coreos/clair) ⭐ 11,054 | 🐛 60 | 🌐 Go | 📅 2026-08-31 - 静态分析工具，用于探测应用容器镜像（e.g. Docker）中的漏洞
...
另请参阅： [Awesome-Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,909 | 🐛 11 | 📅 2024-04-03.

* [FuzzBench](https://google.github.io/fuzzbench/) -  用于根据Google规模的各种实际基准来评估模糊测试器的一项免费服务

### 策略执行

* [Tang](https://github.com/latchset/tang) ⭐ 726 | 🐛 41 | 🌐 C | 📅 2025-03-06 - 用于将数据绑定到网络状态的服务器。只有当客户端位于特定的（安全的）网络上时才向客户端提供数据
* [OpenPolicyAgent](https://www.openpolicyagent.org/)  - 用于跨云原生环境进行统一策略控制的一套工具集和框架

## 蜜罐

另请参阅：[awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,542 | 🐛 23 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,143 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - 可以自承载的Honey Token生成器及报告模版，演示版本可查看：[CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,543 | 🐛 50 | 🌐 C | 📅 2024-06-03 - 一种SSH tarpit，可以缓慢地发送无休止的SSH banner
...
* [Artillery](https://github.com/BinaryDefense/artillery) ⭐ 1,040 | 🐛 25 | 🌐 Python | 📅 2022-01-06 - 一套结合了蜜罐，文件系统监视器和警报系统的工具，旨在保护Linux和Windows操作系统
...
另请参阅：[awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,368 | 🐛 76 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,225 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - 可用于可视化分析Windows事件日志来调查恶意的Windows登录
...
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR) ⭐ 2,033 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-31 - 一个网络安全事件管理平台，可以轻松创建，跟踪和报告网络安全事件
...
* [OSXAuditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,133 | 🐛 8 | 🌐 JavaScript | 📅 2020-07-27 - 一个免费的macOS计算机取证工具
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,290 | 🐛 39 | 🌐 Python | 📅 2026-07-09 - 用于快速提出建议来改善SSH服务器安全状况的一个简易工具
* [Gatekeeper](https://github.com/AltraMayor/gatekeeper) ⭐ 1,633 | 🐛 96 | 🌐 C | 📅 2025-11-05 - 第一个开源的、用于分布式拒绝服务（DDoS）保护的系统
...
另请参阅[awesome-pentest § Social Engineering Tools](https://github.com/fabacab/awesome-pentest#social-engineering-tools) ⭐ 281 | 🐛 0 | 📅 2023-10-23

* [King Phisher](https://github.com/securestate/king-phisher) ⭐ 2,583 | 🐛 2 | 🌐 Python | 📅 2026-08-04 - 通过模拟真实的网络钓鱼攻击来测试和提高用户意识的工具
* [phishing\_catcher](https://github.com/x0rz/phishing_catcher) ⭐ 1,823 | 🐛 44 | 🌐 Python | 📅 2024-08-13 - 使用[CertStream](https://certstream.calidog.io/)服务在证书透明日志(CTL)中通过域名监视可疑TLS证书的可配置脚本
* [CertSpotter](https://github.com/SSLMate/certspotter) ⭐ 1,173 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - 来自SSLMate的证书透明日志监视器，当你的某个域被颁发SSL/TLS证书时，该监视器会发出警报
...
* [NotifySecurity](https://github.com/certsocietegenerale/NotifySecurity) ⚠️ Archived - Outlook加载项，用于帮助您的用户向安全团队报告可疑电子邮件。
...
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,765 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - 可以使系统看起来像APT攻击受害者的工具集
* [Network Flight Simulator (`flightsim`)](https://github.com/alphasoc/flightsim) ⭐ 1,364 | 🐛 24 | 🌐 Go | 📅 2024-04-04 - 用于生成恶意网络流量，可帮助安全团队评估安全控制以及审核他们网络的可见性
* [RedHunt OS](https://github.com/redhuntlabs/RedHunt-OS) ⭐ 1,318 | 🐛 7 | 📅 2025-01-22 - 基于Ubuntu的开放式虚拟设备（`.ova`），预配置了多个威胁仿真工具以及防守方的工具包
* [Metta](https://github.com/uber-common/metta) ⭐ 1,146 | 🐛 13 | 🌐 Python | 📅 2019-04-01 - 自动化的信息安全防范工具，可以进行对抗性模拟
* [DumpsterFire](https://github.com/TryCatchHCF/DumpsterFire) ⭐ 1,040 | 🐛 4 | 🌐 Python | 📅 2020-05-27 - 一个模块化，菜单驱动的跨平台工具，可用于为蓝队演练和传感器/警报映射构建可重复的、延迟的、分布式的安全事件
...
* [Wazuh](https://wazuh.com/) - 开源的、基于多平台代理的安全监视平台。基于[OSSEC HIDS](https://github.com/ossec/ossec-hids) ⭐ 5,053 | 🐛 124 | 🌐 C | 📅 2026-08-26分支开发

### 网络安全监控（NSM）

Network Security Monitoring (NSM)

另请参阅：[awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,418 | 🐛 14 | 📅 2025-09-03.

* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,592 | 🐛 34 | 🌐 Python | 📅 2026-09-01 - 一个恶意网络流量检测系统
* [Moloch](https://github.com/aol/moloch) ⭐ 7,460 | 🐛 39 | 🌐 C | 📅 2026-09-01 - 可扩展当前的安全基础架构，以标准的PCAP格式存储和索引网络流量，从而实现快速的索引访问
* [Stenographer](https://github.com/google/stenographer) ⚠️ Archived - 可进行全包捕获的实用程序，用于将数据包缓冲到磁盘以进行入侵检测和事件响应
* [VAST](https://github.com/tenzir/vast) ⭐ 758 | 🐛 0 | 🌐 C++ | 📅 2026-09-01 - 一个用于数据驱动的安全调查的免费开源网络遥测引擎
* [Real Intelligence Threat Analysis (RITA)](https://github.com/activecm/rita) ⭐ 633 | 🐛 25 | 🌐 Go | 📅 2026-06-17 - 是一套用于网络流量分析的开源框架，可吸收Zeek日志并检测信标，DNS隧道等
...
* [SpoofSpotter](https://github.com/NetSPI/SpoofSpotter) ⭐ 51 | 🐛 1 | 🌐 Python | 📅 2018-06-13 - 捕获被欺骗的NetBIOS名称服务（NBNS）响应，并发出电子邮件或日志文件形式的警告
  * 补充
...
另请参阅：[awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,043 | 🐛 0 | 📅 2026-08-29.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,532 | 🐛 633 | 🌐 C++ | 📅 2026-08-25 - 一个适用于macOS、Windows和Linux的操作系统插装框架，其将操作系统公开为高性能关系数据库，可以使用类似sql的语法进行查询
...
另请参阅：[awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,717 | 🐛 53 | 📅 2026-01-05.

* [GRR Rapid Response](https://github.com/google/grr) ⭐ 5,089 | 🐛 191 | 🌐 Python | 📅 2026-05-12 - 一个专注于远程实时取证的事件响应框架，该组件由安装在资产上的Python代理和基于Python的服务器组成基础结构，使分析师能够快速分类攻击并进行远程分析
...
* [DeepBlueCLI](https://github.com/sans-blue-team/DeepBlueCLI) ⭐ 2,429 | 🐛 13 | 🌐 PowerShell | 📅 2023-10-14 - 用于通过Windows事件日志进行寻线分组的PowerShell模块
...
* [CimSweep](https://github.com/PowerShellMafia/CimSweep) ⭐ 657 | 🐛 2 | 🌐 PowerShell | 📅 2019-08-19 - 基于CIM / WMI的工具套件，可在所有Windows版本中进行远程事件响应和[Hunting](https://github.com/PowerShellMafia/CimSweep) ⭐ 657 | 🐛 2 | 🌐 PowerShell | 📅 2019-08-19操作
...
另请参阅：[awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,588 | 🐛 117 | 📅 2026-05-31.
...
* [ThreatIngestor](https://github.com/InQuest/ThreatIngestor) ⭐ 926 | 🐛 15 | 🌐 Python | 📅 2026-05-26 - 可扩展工具，用于从威胁源（包括Twitter，RSS或其他源）提取和聚合IOC
* [Active Directory Control Paths](https://github.com/ANSSI-FR/AD-control-paths) ⚠️ Archived - 可视化Active Directory权限配置并对其进行图形化处理，用来审核诸如“谁可以阅读CEO的电子邮件？”之类的问题
* [MLSec Combine](https://github.com/mlsecproject/combine) ⭐ 654 | 🐛 45 | 🌐 Python | 📅 2019-03-14 - 该工具收集并组合多个威胁情报源，并将其组合成一种可定制的，基于CSV的标准化格式
* [Forager](https://github.com/opensourcesec/Forager) ⭐ 178 | 🐛 3 | 🌐 Python | 📅 2018-01-23 - 使用Python3构建的多线程威胁情报收集工具。基于文本进行了简单配置和数据存储，以简化使用和数据可移植性。
* [DATA](https://github.com/hadojae/DATA) ⭐ 99 | 🐛 15 | 🌐 Python | 📅 2018-08-22 - 用于网络钓鱼凭据分析和自动化的工具，可以直接接收可疑网络钓鱼URL，或在观察到的包含此类URL的网络流量时触发
...
另请参阅：[awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 509 | 🐛 3 | 📅 2023-09-03.
...
* [MITMEngine](https://github.com/cloudflare/mitmengine) ⚠️ Archived - 一个Golang库，用于在服务器端检测TLS拦截事件
...
* [Stronghold](https://github.com/alichtman/stronghold) ⭐ 1,191 | 🐛 10 | 🌐 Python | 📅 2025-02-24 - 用于在终端轻松配置macOS安全设置
* [macOS Fortress](https://github.com/essandess/macOS-Fortress) ⭐ 451 | 🐛 1 | 🌐 Shell | 📅 2021-11-24 - 提供内核级、操作系统级和客户端级安全功能的自动配置，包括私有化代理和macOS的防病毒扫描。
...
另请参阅：[awesome-windows#security](https://github.com/Awesome-Windows/Awesome#security)和[awesome-windows-domain-hardening](https://github.com/PaulSec/awesome-windows-domain-hardening) ⭐ 1,798 | 🐛 1 | 📅 2020-01-07。

* [HardenTools](https://github.com/securitywithoutborders/hardentools) ⭐ 3,105 | 🐛 12 | 🌐 Go | 📅 2025-08-10 - 一个可用于禁用许多危险的Windows功能的实用程序
...
* [NotRuler](https://github.com/sensepost/notruler) ⭐ 96 | 🐛 3 | 🌐 Go | 📅 2017-10-11 - 用于侦测尝试破坏Microsoft Exchange服务器的行为，并同时检测由[Ruler](https://github.com/sensepost/ruler) ⭐ 2,313 | 🐛 14 | 🌐 Go | 📅 2024-06-10攻击工具使用的客户端规则和启用VBScript的表单
