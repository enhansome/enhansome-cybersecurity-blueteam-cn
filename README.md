...
* [Posh-VirusTotal](https://github.com/darkoperator/Posh-VirusTotal) ⭐ 123 | 🐛 7 | 🌐 PowerShell | 📅 2020-01-16 - 可与VirusTotal.com的API进行交互的PowerShell接口
...
另请参阅：[awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,407 | 🐛 86 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,277 | 🐛 22 | 🌐 Python | 📅 2026-08-02 - 可用于可视化分析Windows事件日志来调查恶意的Windows登录
...
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR) ⭐ 2,038 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-14 - 一个网络安全事件管理平台，可以轻松创建，跟踪和报告网络安全事件
...
* [Wazuh](https://wazuh.com/) - 开源的、基于多平台代理的安全监视平台。基于[OSSEC HIDS](https://github.com/ossec/ossec-hids) ⭐ 5,059 | 🐛 125 | 🌐 C | 📅 2026-09-17分支开发
...
另请参阅：[awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,676 | 🐛 140 | 📅 2026-05-31.
