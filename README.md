...
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,257 | 🐛 161 | 🌐 Shell | 📅 2026-07-25 - 对于自动解密的可插入式工具，经常被用做[Tang](https://github.com/latchset/tang) ⭐ 731 | 🐛 41 | 🌐 C | 📅 2025-03-06客户端
...
* [libcrafter](https://github.com/pellegre/libcrafter) ⭐ 312 | 🐛 1 | 🌐 Rust | 📅 2026-09-16 - 一个c++的高级库，用于创建和解码网络数据包
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,336 | 🐛 838 | 🌐 Go | 📅 2026-09-17 - 用Go编写的应用程序内核，它实现Linux系统表面的很大一部分，用以在应用程序和主机内核之间提供隔离边界
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,823 | 🐛 380 | 🌐 Python | 📅 2026-09-16 - 基于AWS-CLI命令的工具，用于Amazon Web Services帐户安全性评估和增强
...
另请参阅：[awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,473 | 🐛 89 | 📅 2024-05-11
...
* [Clair](https://github.com/coreos/clair) ⭐ 11,056 | 🐛 52 | 🌐 Go | 📅 2026-09-16 - 静态分析工具，用于探测应用容器镜像（e.g. Docker）中的漏洞
...
* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,163 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - 可以自承载的Honey Token生成器及报告模版，演示版本可查看：[CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,557 | 🐛 49 | 🌐 C | 📅 2024-06-03 - 一种SSH tarpit，可以缓慢地发送无休止的SSH banner
...
另请参阅：[awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,390 | 🐛 82 | 📅 2026-07-15.
...
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR) ⭐ 2,035 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-14 - 一个网络安全事件管理平台，可以轻松创建，跟踪和报告网络安全事件
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,301 | 🐛 39 | 🌐 Python | 📅 2026-07-09 - 用于快速提出建议来改善SSH服务器安全状况的一个简易工具
...
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,771 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - 可以使系统看起来像APT攻击受害者的工具集
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,604 | 🐛 37 | 🌐 Python | 📅 2026-09-16 - 一个恶意网络流量检测系统
* [Moloch](https://github.com/aol/moloch) ⭐ 7,468 | 🐛 38 | 🌐 C | 📅 2026-09-16 - 可扩展当前的安全基础架构，以标准的PCAP格式存储和索引网络流量，从而实现快速的索引访问
...
另请参阅：[awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,175 | 🐛 0 | 📅 2026-09-14.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,572 | 🐛 650 | 🌐 C++ | 📅 2026-09-16 - 一个适用于macOS、Windows和Linux的操作系统插装框架，其将操作系统公开为高性能关系数据库，可以使用类似sql的语法进行查询
...
另请参阅：[awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,726 | 🐛 57 | 📅 2026-01-05.
...
* [DeepBlueCLI](https://github.com/sans-blue-team/DeepBlueCLI) ⭐ 2,431 | 🐛 13 | 🌐 PowerShell | 📅 2023-10-14 - 用于通过Windows事件日志进行寻线分组的PowerShell模块
...
另请参阅：[awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,648 | 🐛 138 | 📅 2026-05-31.
