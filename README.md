...
本项目基于[awesome-cybersecurity-blueteam](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,542 | 🐛 75 | 📅 2024-07-15，经过蹩脚的翻译和一些补充，**旨在帮助以中文为母语的安全研究者更好地了解蓝队工作，以及便利地找寻蓝队工具**。
...
* [censys-python](https://github.com/censys/censys-python) ⭐ 469 | 🐛 1 | 🌐 Python | 📅 2026-08-27 - 对Censys REST API的Python轻量级封装
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,178 | 🐛 835 | 🌐 Go | 📅 2026-08-28 - 用Go编写的应用程序内核，它实现Linux系统表面的很大一部分，用以在应用程序和主机内核之间提供隔离边界
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,701 | 🐛 288 | 🌐 Python | 📅 2026-08-27 - 基于AWS-CLI命令的工具，用于Amazon Web Services帐户安全性评估和增强
...
* [Git Secrets](https://github.com/awslabs/git-secrets) ⭐ 13,383 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - 用于防止用户提交密码或其他的敏感信息到Git仓库
...
另请参阅：[awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,535 | 🐛 23 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,141 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - 可以自承载的Honey Token生成器及报告模版，演示版本可查看：[CanaryTokens.org](https://canarytokens.org/).
...
另请参阅：[awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,355 | 🐛 75 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,223 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - 可用于可视化分析Windows事件日志来调查恶意的Windows登录
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,283 | 🐛 39 | 🌐 Python | 📅 2026-07-09 - 用于快速提出建议来改善SSH服务器安全状况的一个简易工具
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,587 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - 一个恶意网络流量检测系统
* [Moloch](https://github.com/aol/moloch) ⭐ 7,459 | 🐛 35 | 🌐 C | 📅 2026-08-27 - 可扩展当前的安全基础架构，以标准的PCAP格式存储和索引网络流量，从而实现快速的索引访问
...
另请参阅：[awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,008 | 🐛 0 | 📅 2026-08-27.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,525 | 🐛 629 | 🌐 C++ | 📅 2026-08-25 - 一个适用于macOS、Windows和Linux的操作系统插装框架，其将操作系统公开为高性能关系数据库，可以使用类似sql的语法进行查询
...
另请参阅：[awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 508 | 🐛 3 | 📅 2023-09-03.
